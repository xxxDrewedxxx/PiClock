...
for bus in buses:
    command += 'ddcutil setvcp 10 5 --bus 2' 
...
digitalformat2 = "{0:%H:%M}"  # Format of the digital time on second screen
...
dimcolor.setAlpha(0) #dimcolor.setAlpha(0)
